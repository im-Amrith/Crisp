  ...
  return (
    <div className="bg-white rounded-xl shadow-lg p-6">
      <div className="flex items-center space-x-2 mb-6">
        ...
        <h2 className="text-xl font-bold text-gray-900">PCSE Model Status</h2>
      </div>

      {/* Stress Indicators */}
      <div className="mb-6">
        <h3 className="font-semibold text-gray-900 mb-3">Stress Indicators</h3>
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              <Droplets className="w-4 h-4 text-blue-500" />
              <span className="text-sm text-gray-900">Water</span>
            </div>
            <div className="flex items-center space-x-2">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm text-gray-900">Nitrogen</span>
            </div>
            <div className="flex items-center space-x-2">
      ...
      <div className="space-y-4">
        <h3 className="font-semibold text-gray-900">Model Insights</h3>
      ...
      <div className="mt-6 pt-4 border-t border-gray-200">
        <div className="text-center">
          <div className="text-xs text-gray-900 mb-1">Powered by</div>
          <div className="text-sm font-semibold text-gray-900">PCSE/WOFOST Model</div>
          <div className="text-xs text-gray-900">Process-based crop simulation</div>
        </div>
      </div>
    </div>
  );
